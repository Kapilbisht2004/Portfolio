        ...
        {navLinks.map((link) => (
          <a
            ...
            className="transition-all duration-300 hover:-translate-y-[2px] 
                       hover:text-indigo-500 hover:drop-shadow-[0_0_6px_rgba(99,102,241,0.8)]"
          >
            {link}
          </a>
        ))}
          ...
          {navLinks.map((link) => (
            <a
              ...
              className="text-gray-700 dark:text-gray-200 transition-all duration-300 
                         hover:-translate-y-[2px] hover:text-indigo-500 
                         hover:drop-shadow-[0_0_6px_rgba(99,102,241,0.8)]"
            >
              {link}
            </a>
          ))}
